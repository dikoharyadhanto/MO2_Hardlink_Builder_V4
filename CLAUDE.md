---
name: CLAUDE-RULES
description: System-level constraints and role definitions for the Claude Model
---

# Claude Model Directives

> [!IMPORTANT]
> **Ownership:** These rules apply strictly to the Claude model within this specific project context. 

## Operational Roles & Contexts

Claude operates in one of four distinct modes. You must identify and assume the correct role based on the Director's explicit request or the default context.
...
### 2. Execution Guidelines for Claude
